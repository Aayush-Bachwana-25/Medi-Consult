...
public class Doctor extends  Person {
    ...
    Doctor(String firstname,String lastName,String emailAddress,String password,String mobile,String Address,String doctorFees,String degree,String specialization){
